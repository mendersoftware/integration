...
class Deployments(object):
    ...
    def check_expected_status(self, expected_status, deployment_id, max_wait=1200, polling_frequency=.2):
    ...
    def check_expected_statistics(self, deployment_id, expected_status, expected_count, max_wait=1200, polling_frequency=.2):
        timeout = time.time() + max_wait
        seen = set()
