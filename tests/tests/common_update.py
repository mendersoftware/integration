...
def common_update_procedure_with_scripts(install_image,
                            regenerate_image_id=True,
                            scripts=None,
                            device_type="vexpress-qemu",
                            broken_image=False,
    ...
    with artifact_lock:
        ...
        # create atrifact
        with tempfile.NamedTemporaryFile() as artifact_file:
            created_artifact = image.make_artifact_with_scripts(install_image, device_type, artifact_id, scripts, artifact_file)
...
def update_image_successful_scripts(install_image=conftest.get_valid_image(), regenerate_image_id=True, scripts=None):
    """
    ...
    deployment_id, expected_image_id = common_update_procedure_with_scripts(install_image,
                                                               regenerate_image_id, scripts=scripts)
...
def update_image_failed_scripts(install_image="broken_update.ext4", scripts=None):
    """
    ...
    deployment_id, _ = common_update_procedure_with_scripts(install_image, broken_image=True, scripts=scripts)
