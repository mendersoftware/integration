...
from mender_integration.testutils.common import wait_until_healthy
from mender_integration.testutils.infra.container_manager.docker_compose_base_manager import DockerComposeBaseNamespace, docker_lock
...
class DockerComposeNamespace(DockerComposeBaseNamespace):
    ...
    BASE_FILES = [
        os.path.join(COMPOSE_FILES_PATH, "docker-compose.yml"),
        os.path.join(COMPOSE_FILES_PATH, "docker-compose.storage.minio.yml"),
        os.path.join(COMPOSE_FILES_PATH, "docker-compose.demo.yml"),
        os.path.join(COMPOSE_FILES_PATH, "extra/integration-testing/docker-compose.yml"),
    ]
    QEMU_CLIENT_FILES = [
        os.path.join(COMPOSE_FILES_PATH, "docker-compose.client.yml"),
    ]
    QEMU_EXTENDED_FILES = [
        os.path.join(COMPOSE_FILES_PATH, "docker-compose.client.extended.yml"),
    ]
    MONITOR_CLIENT_COMMERCIAL_FILES = [
        os.path.join(COMPOSE_FILES_PATH, "docker-compose.monitor-client.commercial.yml"),
    ]
    QEMU_CLIENT_ROFS_FILES = [
        os.path.join(COMPOSE_FILES_PATH, "docker-compose.client.yml"),
        os.path.join(COMPOSE_FILES_PATH, "docker-compose.client.rofs.yml"),
    ]
    QEMU_CLIENT_ROFS_COMMERCIAL_FILES = [
        os.path.join(COMPOSE_FILES_PATH, "docker-compose.client.yml"),
        os.path.join(COMPOSE_FILES_PATH, "docker-compose.client.rofs.commercial.yml"),
    ]
    DOCKER_CLIENT_FILES = [
        os.path.join(COMPOSE_FILES_PATH, "docker-compose.docker-client.addons.yml"),
    ]
    LEGACY_V1_CLIENT_FILES = [
        os.path.join(COMPOSE_FILES_PATH, "docker-compose.client.yml"),
        os.path.join(COMPOSE_FILES_PATH, "extra/legacy-clients-testing/legacy-v1-client.yml"),
        os.path.join(COMPOSE_FILES_PATH, "storage-proxy/docker-compose.storage-proxy.yml"),
        os.path.join(COMPOSE_FILES_PATH, "storage-proxy/docker-compose.storage-proxy.testing.yml"),
    ]
    LEGACY_V3_CLIENT_FILES = [
        os.path.join(COMPOSE_FILES_PATH, "extra/legacy-clients-testing/legacy-v3-client.yml"),
    ]
    SIGNED_ARTIFACT_CLIENT_FILES = [
        os.path.join(COMPOSE_FILES_PATH, "extra/signed-artifact-client-testing/docker-compose.signed-client.yml"),
    ]
    SHORT_LIVED_TOKEN_FILES = [
        os.path.join(COMPOSE_FILES_PATH, "extra/expired-token-testing/docker-compose.short-token.yml"),
    ]
    FAILOVER_SERVER_FILES = [
        os.path.join(COMPOSE_FILES_PATH, "extra/failover-testing/docker-compose.failover-server.yml"),
    ]
    ENTERPRISE_FILES = [
        os.path.join(COMPOSE_FILES_PATH, "docker-compose.enterprise.yml"),
        os.path.join(COMPOSE_FILES_PATH, "docker-compose.testing.enterprise.yml"),
    ]
    MT_CLIENT_FILES = [
        os.path.join(COMPOSE_FILES_PATH, "docker-compose.client.yml"),
        os.path.join(COMPOSE_FILES_PATH, "docker-compose.mt.client.yml"),
    ]
    ...
    MTLS_FILES = [
        os.path.join(COMPOSE_FILES_PATH, "extra/mtls/docker-compose.mtls-test.yml"),
        os.path.join(COMPOSE_FILES_PATH, "docker-compose.client.yml"),
        os.path.join(COMPOSE_FILES_PATH, "docker-compose.mt.client.yml"),
    ]
    SMTP_MOCK_FILES = [
        os.path.join(COMPOSE_FILES_PATH, "extra/smtp-testing/workflows-worker-smtp-mock.yml"),
        os.path.join(COMPOSE_FILES_PATH, "extra/recaptcha-testing/tenantadm-test-recaptcha-conf.yml"),
        os.path.join(COMPOSE_FILES_PATH, "extra/smtp-testing/smtp.mock.yml"),
    ]
