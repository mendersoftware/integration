...
def standard_setup_one_docker_client_bootstrapped_impl():
    env = container_factory.get_docker_client_setup()
    env.setup()
...
def standard_setup_one_docker_client_bootstrapped():
    yield from standard_setup_one_docker_client_bootstrapped_impl()


@pytest.fixture(scope="class")
def class_persistent_standard_setup_one_docker_client_bootstrapped():
    yield from standard_setup_one_docker_client_bootstrapped_impl()
...
def enterprise_one_docker_client_bootstrapped_impl():
...
def enterprise_one_docker_client_bootstrapped():
    yield from enterprise_one_docker_client_bootstrapped_impl()


@pytest.fixture(scope="class")
def class_persistent_enterprise_one_docker_client_bootstrapped():
    yield from enterprise_one_docker_client_bootstrapped_impl()
