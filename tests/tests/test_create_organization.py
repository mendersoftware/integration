...
class TestCreateOrganizationEnterprise(MenderTesting):
    ...
    def test_success(self):
        ...
        rsp = requests_retry().post("https://%s/api/management/v1/tenantadm/tenants" % get_mender_gateway(), timeout=512, data=payload, verify=False)
        ...
        r = requests_retry().post("https://%s/api/management/%s/useradm/auth/login" % (get_mender_gateway(), api_version), timeout=512,
                                  verify=False,
