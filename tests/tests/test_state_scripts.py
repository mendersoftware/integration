...
def run_one_state_script_test(test_set):
    try:
        ...
        if TestStateScripts.instance.client is None:
            TestStateScripts.instance.client = TestStateScripts.instance.client_queue.get_nowait()

        # Run test.
        TestStateScripts.instance.run_one_state_script_test_on_client(client=TestStateScripts.instance.client,
                                                                      test_set=test_set)
    except:
...
class TestStateScripts(MenderTesting):
    scripts = [
        ...
        "ArtifactRollbackReboot_Error_88",
    ...
    test_sets = [
        ...
        },
        {
            ...
            "ScriptOrder": [
                ...
                "Sync_Leave_04",
                "Sync_Leave_15",
                # TODO: MEN-XXX These should be executed.
                # "Sync_Error_15",
                # "Sync_Error_16",
                "Idle_Enter_08_testing",
                "Idle_Enter_09",
        ...
        },
        {
            ...
            "ScriptOrder": [
                ...
                "ArtifactInstall_Enter_02",
                "ArtifactInstall_Leave_01",
                # TODO: MEN-XXX There should be executed.
                # "ArtifactInstall_Error_01",
                # "ArtifactInstall_Error_02",
                # "ArtifactInstall_Error_99",
                # TODO These should be entered.
                # "ArtifactRollback_Enter_00",
                # "ArtifactRollback_Enter_01",
                # "ArtifactRollback_Leave_00",
                # "ArtifactRollback_Leave_01",
        ...
        # },
        {
            ...
            "ScriptOrder": [
                ...
                "ArtifactReboot_Leave_89",
                "ArtifactReboot_Leave_99",
                # TODO START --- This whole block is wrong, it should be the one below.
                "ArtifactRollbackReboot_Enter_00",
                "ArtifactRollbackReboot_Enter_99",
                "ArtifactRollback_Enter_00",
                "ArtifactRollback_Enter_01",
    ...
    def test_state_scripts(self):
        ...
        # Create worker pool.
        TestStateScripts.instance = self
    ...
    def run_one_state_script_test_on_client(self, client, test_set):
        ...
        try:
            ...
            deployment_id = common_update_procedure(install_image=new_rootfs,
                                                    broken_image=test_set['BrokenArtifactId'],
                                                    verify_status=False,
                                                    devices=[device_id],
