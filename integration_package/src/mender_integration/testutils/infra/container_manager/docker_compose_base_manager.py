...
from mender_integration.testutils.infra.container_manager.docker_manager import DockerNamespace
...
class DockerComposeBaseNamespace(DockerNamespace):
    ...
    COMPOSE_FILES_PATH = resources.files("mender_integration.compose_files")
